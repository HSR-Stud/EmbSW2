...
\subsection{Performancebetrachtungen (Zeit und Codegrösse)}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item This is external fragmentation
    \end{itemize}
  \end{itemize}
  \item \textbf{Memory leaks}
  \begin{itemize}
    \item Will some allocations go undeallocated?
  \end{itemize}
...
\subsubsection{double-Konstanten}
\begin{itemize}
...
\subsubsection{Compiler Generated Data}
